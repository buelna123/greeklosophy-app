...
const AssignmentSubmission = () => {
    ...
    return (_jsxs(Container, { className: "course-experience-container", children: [_jsx("h2", { className: "mb-4", children: "Entrega de Tarea" }), !quizSubmitted ? (_jsxs(Alert, { variant: "warning", children: ["Debes completar el ", _jsx("strong", { children: "Quiz" }), " antes de poder entregar la tarea."] })) : loadingStatus ? (_jsx("div", { className: "text-center my-5", children: _jsx(Spinner, { animation: "border", variant: "primary" }) })) : !assignment ? (_jsx(Alert, { variant: "warning", children: "No se encontr\u00F3 la tarea solicitada o no est\u00E1 asignada." })) : (_jsxs(_Fragment, { children: [_jsx(Card, { className: "content-area uniform-card mb-4", children: _jsxs(Card.Body, { children: [_jsx(Card.Title, { children: assignment.title }), _jsx(Card.Text, { children: assignment.description })] }) }), _jsx(Card, { className: "shadow-sm border-0 uniform-card", style: { backgroundColor: "#fff" }, children: _jsx(Card.Body, { children: submitted && !editMode ? (_jsxs("div", { children: [_jsxs(Alert, { variant: "success", className: "d-flex align-items-center gap-2", children: [_jsx(FaCheckCircle, {}), " La tarea ya fue entregada."] }), _jsx(Button, { variant: "outline-primary", onClick: handleEdit, children: "Editar Tarea" })] })) : (_jsxs(Form, { ref: formRef, onSubmit: handleSubmit, children: [errorMsg && _jsx(Alert, { variant: "danger", children: errorMsg }), successMsg && _jsx(Alert, { variant: "success", children: successMsg }), _jsxs(Form.Group, { className: "mb-3", controlId: "assignmentFile", children: [_jsx(Form.Label, { className: "form-label", children: "Seleccione el archivo a entregar" }), _jsx(Form.Control, { type: "file", onChange: handleFileChange, className: "form-control" })] }), _jsx("div", { className: "d-grid", children: _jsx(Button, { variant: "primary", type: "submit", disabled: mutation.isLoading, className: "btn-primary", children: mutation.isLoading ? (_jsx(Spinner, { as: "span", animation: "border", size: "sm", role: "status", "aria-hidden": "true" })) : submitted ? "Actualizar Tarea" : "Enviar Tarea" }) })] })) }) })] }))] }));
};
