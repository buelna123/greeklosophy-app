...
const AdminAssignments = () => {
    ...
    return (_jsxs(Container, { className: "admin-container", children: [_jsx("h1", { children: "Gesti\u00F3n de Asignaciones" }), _jsx(Button, { variant: "primary", className: "admin-button-primary mb-3", onClick: () => handleShowModal(), children: "Crear Nueva Asignaci\u00F3n" }), isLoading ? (_jsx("div", { className: "text-center my-4", children: _jsx(Spinner, { animation: "border", role: "status", children: _jsx("span", { className: "visually-hidden", children: "Cargando..." }) }) })) : (_jsxs(Table, { striped: true, bordered: true, hover: true, responsive: true, className: "admin-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: "ID" }), _jsx("th", { children: "Curso" }), _jsx("th", { children: "T\u00EDtulo" }), _jsx("th", { children: "Fecha L\u00EDmite" }), _jsx("th", { children: "Acciones" })] }) }), _jsx("tbody", { children: assignmentsData?.map((assignment) => (_jsxs("tr", { children: [_jsx("td", { children: assignment.id }), _jsx("td", { children: assignment.course_name || assignment.course_id }), _jsx("td", { children: assignment.title }), _jsx("td", { children: formatDate(assignment.due_date) }), _jsxs("td", { children: [_jsx(Button, { className: "admin-button me-2", onClick: () => handleShowModal(assignment), children: "Editar" }), _jsx(Button, { variant: "danger", className: "admin-button", onClick: () => handleDelete(assignment.id), children: "Eliminar" })] })] }, assignment.id))) })] })), _jsx(AssignmentModal, { show: showModal, onHide: handleCloseModal, editingAssignment: editingAssignment, onSuccess: () => queryClient.invalidateQueries(["adminAssignments"]) })] }));
};
